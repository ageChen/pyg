<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"D:\phpstudy_pro\WWW\pyg\public/../application/home\view\cart\index.html";i:1599270476;s:57:"D:\phpstudy_pro\WWW\pyg\application\home\view\layout.html";i:1599375991;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
...
<script>
	$(function (){
		...
		$('.check_all').change(function (){
			...
			var data = {
				"id":"all",
				"status":$(this).prop('checked') ? 1 : 0 		//选中为1，不选中为0
			}
			//发送ajax请求
			$.ajax({
		...
		//修改购买数量的封装函数
		function change_number(number,element) {
			var data = {
			...
			$.ajax({
				...
				"success": function (res){
					...
					//将新的数量重新备份到标签属性上，用于数量出错的恢复
					$(element).closest('ul').attr('number',number);
					//重新计算小计金额
						//获取单价
					var price = $(element).closest('ul').find('.price').html();
						//计算小计金额
