<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"D:\phpstudy_pro\WWW\pyg\public/../application/home\view\goods\detail.html";i:1599120628;s:57:"D:\phpstudy_pro\WWW\pyg\application\home\view\layout.html";i:1599532740;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
...
<div id="nav-bottom">
            ...
            <div class="py-container">
                <div class="shortcut">
                    <ul class="fl">
                        ...
                        <li class="f-item">请&nbsp;&nbsp;<a href="<?php echo url('home/login/login'); ?>">登录</a>
                                        ...
                                        <div class="subitem">
                                            ...
                                            <dl class="fore1">
                                                ...
                                                <dd>
                                                    ...
                                                    <em>
                                                        <a href="<?php echo url('home/goods/index',['id'=>$three['id']]); ?>"><?php echo $three['cate_name']; ?></a>
                                                    </em>
                                                    <?php endforeach; ?>
                                                </dd>
                                            </dl>
				...
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<div id="preview" class="spec-preview">
							<span class="jqzoom">
								<img jqimg="<?php if((isset($goods['goods_images'][0]['pics_big']))): ?><?php echo $goods['goods_images'][0]['pics_big']; endif; ?>"
								src="<?php if((isset($goods['goods_images'][0]['pics_sma']))): ?><?php echo $goods['goods_images'][0]['pics_sma']; endif; ?>" />
							</span>
						</div>
						<!--下方的缩略图-->
						<div class="spec-scroll">
							...
							<div class="items">
								<ul>
									...
									<li>
										<img src="<?php echo $v['pics_sma']; ?>" bimg="<?php echo $v['pics_big']; ?>" onmousemove="preview(this)" />
									</li>
									<?php endforeach; ?>
								</ul>
							</div>
	...
	<!-- 隐藏表单用于提交购买信息 -->
	<form style="display: none" action="<?php echo url('home/cart/addcart'); ?>" method="post">
	...
	<script>
		$(function (){
			...
			$('#addshopcar').click(function (){
				...
				//获取对应商品SKU规格值的id  顺带处理一下没有规格SKU的商品
				var spec_goods_id = value_ids_map[value_ids].id ?? '';
			...
			$('#specification').find('a').click(function (){
				...
				value_ids = value_ids.slice(0,-1);
				//显示价格到界面
				$('#goods_price').html(value_ids_map[value_ids].price);
			});
