<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"D:\phpstudy_pro\WWW\pyg\public/../application/home\view\order\pay.html";i:1599472060;s:57:"D:\phpstudy_pro\WWW\pyg\application\home\view\layout.html";i:1599375991;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
			...
			<div class="checkout-steps">
				...
				<div class="step-cont">
					<ul class="payType">
						...
						<li pay_code = "<?php echo $v['pay_code']; ?>" <?php if(($v['pay_code'] =='alipay')): ?> style="border: 2px solid rgb(228, 57, 60);" <?php endif; ?>>
...
<!--	隐藏表单 -->
	<form id="payForm" action="<?php echo url('home/order/pay'); ?>" method="post" style="display:none;">
